defmodule SustinemusClientWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SustinemusClientWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SustinemusClientWeb.Gettext, "errors", msg, opts)
    end
  end
